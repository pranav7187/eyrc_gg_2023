...
# Team ID:			GG_2787
# Author List:		Pranav Bakshi, Subarno Maji, Shobhit Kumar Shukla, Shahzeb Arshad
# Filename:			Task_2D.py
...
def read_csv(csv_name):
    ...
    with open(csv_name, 'r') as csv_file:
        ...
        for line in csv_reader:
            ...
            lat_lon.update({line[0] : [line[1], line[2]] })
...
def write_csv(loc, csv_name):
    ...
    '''
    with open(csv_name, mode='a+', newline='') as csv_loc_file:
        csv_writer = csv.writer(csv_loc_file)
        fields = ['lat', 'lon'] 
...
def tracker(ar_id, lat_lon):
    ...
    with open("live_data.csv", mode='a+', newline='') as csv_new_file:
